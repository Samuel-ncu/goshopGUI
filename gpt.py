...
class OrderScraperApp(QWidget):
    ...
    def scrape_data(self):
        ...
        lastorder_file = os.path.join(self.current_user_dir, "lastorder.txt") if self.current_user_dir else None
        if lastorder_file and os.path.exists(lastorder_file):
            try:
        ...
        try:
            ...
            while not stop_grabbing:
                ...
                for i in range(table_rows.count()):
                    ...
                    # 假設第 2 欄為訂單編號，第 8 欄為 Delivery Status
            ...
            if lastorder_file and os.path.exists(lastorder_file):
                ...
                file_path_pending = os.path.join(self.base_dir,
